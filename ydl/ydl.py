...
def setup_parser():
    ...
    parser.add_argument('-c', '--cookies-from-browser', nargs=2, metavar=('BROWSER_NAME', 'PROFILE_NAME_OR_PATH'), help='Load cookies from "<browser_name>" "<profile_path>" (e.g. "firefox" "default" or "firefox" "/home/user/.librewolf/foobar.default")')
    ...
    parser.add_argument('-t', '--cleanup-download-archives', help='Cleanup download archive files after complete playlist download', action='store_true')
...
def main():
    ...
    if args.url:
        ...
        if args.cookies_from_browser:
            print(f"Using cookies from browser '{args.cookies_from_browser[0]}' and profile '{args.cookies_from_browser[1]}'")
            ydl_opts['cookiesfrombrowser'] = (args.cookies_from_browser[0], args.cookies_from_browser[1])
